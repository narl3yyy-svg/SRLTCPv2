...
Using SRLTCP v0.2.7 for secure peer-to-peer messaging.
...
1. Download `SRLTCPv2-0.2.7.apk` from [Releases](https://github.com/narl3yyy-svg/SRLTCPv2/releases/latest) or build locally (see [BUILD.md](BUILD.md))
...
SRLTCP v0.2.7 uses QR-based discovery only — there is no manual IP connect option. QR codes (v3) embed the peer's LAN address so connection starts automatically.
