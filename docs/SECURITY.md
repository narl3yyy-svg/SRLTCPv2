...
6. **Stable identity** — Long-term Ed25519 seed persists across restarts (v0.3.2).
...
Design is modern and layered for stated goals. v0.3.2 is a material step toward daily-driver usability (stable identity, size, honesty). **Still experimental** for high-threat targets until independent audit of crypto crates and engine review.
